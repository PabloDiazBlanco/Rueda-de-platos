...
// Cálculo de macros: getFood, macrosFor, emptyMacros, addMacros, composedMacros y fmt
// viven ahora en macros.js (módulo sin JSX, importado arriba).
...
// Las utilidades de sorteo ponderado y el sistema de reglas de combinación viven ahora
// en seleccion.js (módulo sin JSX, importado arriba). generateMenu se queda aquí porque
// todavía depende de mealTotals y objetivosPorComida, que siguen sin extraer.
...
function nivelMacrosPorSesiones(sesionesSemana) {
...
const NIVELES_ACTIVIDAD_LEGACY = {
