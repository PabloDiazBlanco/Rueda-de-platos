...
import { Plus, Trash2, Pencil, X, Check, Utensils, Wheat, Salad, Package, Sparkles, AlertCircle, CalendarDays, Shuffle, Coffee, Cookie, Database, Search, Link2, Download } from "lucide-react";
...
const SPECIAL_TABS = { menu: MENU_TAB_META, alimentos: FOODS_TAB_META };

function TabBar({ tab, setTab }) {
  const tabs = ["menu", "proteina", "carbo", "verdura", "desayuno", "merienda", "cerrado", "especial", "alimentos"];
  return (
    <nav
      style={{
        display: "flex",
